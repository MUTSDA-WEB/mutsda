    ...
    <div className="bg-[#F6EBEB] min-h-screen">
      ...
      <section className="bg-linear-to-r from-rose-500 to-rose-600 py-20 text-white text-center px-6">
        ...
        <p className="text-xl max-w-2xl mx-auto font-light">
          ...
          To visit the fatherless and widows in their affliction.&quot; — James
          1:27
        </p>
      </section>
        ...
        <section className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            ...
            <p className="text-gray-600 text-lg">
              The Welfare Department is the hands and feet of MUTSDA. We provide
              emotional, spiritual, and financial support to those in need
              within our congregation and the surrounding neighborhood.
            </p>
          ...
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
            <div className="space-y-2">
              ...
              <p className="text-gray-500 max-w-md">
                All proceeds from these sales go directly into the Welfare Fund
        ...
        <section className="grid md:grid-cols-2 gap-8">
          <div className="bg-rose-500 p-10 rounded-[2.5rem] text-white space-y-6 shadow-lg">
            ...
            <p className="opacity-90 leading-relaxed">
              Prefer to give a direct donation? Your contribution helps us
              respond immediately to hospital emergencies and funeral support
