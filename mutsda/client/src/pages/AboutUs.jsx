    ...
    <div className="flex flex-col animate-fadeIn">
      ...
      <section className=" py-16 text-center text-[#3298C8]">
        ...
        <p className="max-w-2xl mx-auto px-4 text-lg opacity-90">
          Rooted in faith, growing in service, and reaching out with love to our
          community.
        </p>
      </section>
      ...
      <div className="max-w-6xl mx-auto w-full py-16 px-6 space-y-20">
        ...
        <section className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-gray-700 leading-relaxed text-lg">
              To share the everlasting gospel of Jesus Christ through worship,
              fellowship, and dedicated community service. We strive to create
              an environment where every soul feels valued and cherished.
            </p>
            <blockquote className="border-l-4 border-sky-400 pl-4 italic text-gray-600">
              <FontAwesomeIcon
                icon={faQuoteLeft}
                className="text-sky-300 mr-2"
              />
        ...
        <section className="bg-white p-10 rounded-3xl shadow-sm border border-sky-100">
          ...
          <div className="grid md:grid-cols-3 gap-8 text-center">
            {[
              {
                title: "Faith",
                desc: "Trusting in God’s word and His guidance for our journey.",
              },
              {
                title: "Community",
                desc: "Building strong, supportive bonds within our congregation.",
              },
              {
                title: "Service",
                desc: "Dedicated to helping those in need with kindness.",
              },
            ].map((value, index) => (
        ...
        <section className="space-y-12">
          <div className="text-center">
            ...
            <p className="text-gray-500 mt-2">
              The dedicated team serving MUTSDA
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
            {[1, 2, 3, 4].map((leader) => (
              <div key={leader} className="text-center group">
                ...
                <p className="text-[#3298C8] text-sm uppercase tracking-wider font-semibold">
                  Position Title
                </p>
              </div>
            ))}
        ...
        <section className="bg-sky-50 p-8 rounded-2xl border-l-8 border-[#3298C8]">
          ...
          <p className="text-gray-700 leading-relaxed">
            Founded with a vision to serve, MUTSDA has grown from a small
            gathering into a vibrant community of believers. Over the years, we
            have expanded our ministries to include library services, youth
            leadership programs, and mission registrations. Our history is
            written in the lives of the people we serve and the faith we share.
          </p>
        </section>
      </div>
    </div>
