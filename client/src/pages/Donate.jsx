   ...
   const funds = [
      {
         ...
         desc: "General church operations and worldwide missions.",
      },
      {
         name: "Welfare Fund",
         icon: faHeart,
         desc: "Supporting the needy, widows, and orphans in our community.",
      },
      {
         name: "Building Project",
         icon: faHandHoldingDollar,
         desc: "Contributions toward the expansion of our sanctuary.",
      },
   ];
   ...
   return (
      <div className='bg-[#F6EBEB] min-h-screen animate-fadeIn'>
         ...
         <section className='bg-[#3298C8] py-20 text-white text-center px-6'>
            ...
            <p className='mt-4 font-bold italic text-sky-200'>
               — 2 Corinthians 9:7
            </p>
         </section>
            ...
            <div className='space-y-8'>
               <div className='space-y-2'>
                  ...
                  <p className='text-gray-500'>
                     Where would you like to direct your support?
                  </p>
               </div>
               ...
               <div className='space-y-4'>
                  {funds.map((fund) => (
                     ...
                     >
                        <div
                           className={`p-4 rounded-2xl ${selectedFund === fund.name ? "bg-[#3298C8] text-white" : "bg-sky-100 text-[#3298C8]"}`}
                        >
                  ...
                  <div className='relative z-10 space-y-8'>
                     ...
                     <div className='space-y-6'>
                        ...
                        <div className='p-4 bg-white/10 rounded-xl text-xs text-gray-400 italic'>
                           * For specific funds, use the fund name (e.g.,
                           WELFARE) as the account number.
                        </div>
                     </div>
               ...
               <div className='bg-white p-8 rounded-[2.5rem] shadow-sm border border-gray-100 flex items-center gap-6'>
                  ...
                  <div>
                     ...
                     <p className='text-xs text-gray-500'>
                        Your contributions are managed with full transparency by
                        the church board.
                     </p>
                  </div>
               </div>
