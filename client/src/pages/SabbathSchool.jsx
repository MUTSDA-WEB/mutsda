...
const SabbathSchool = () => {
  const weeklySchedule = [
    { time: "08:30 AM", activity: "Song Service & Prayer", lead: "Choristers" },
    { time: "09:00 AM", activity: "Missionary Report", lead: "SS Secretary" },
    { time: "09:15 AM", activity: "Lesson Study (Classes)", lead: "Assigned Teachers" },
      ...
      <section className="bg-white border-b border-sky-100">
        <div className="max-w-7xl mx-auto px-6 py-16 flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="w-full lg:w-2/3 space-y-6">
            <h4 className="text-[#3298C8] font-bold tracking-widest uppercase text-sm">Lesson Study</h4>
            <h1 className="text-4xl md:text-5xl font-black text-gray-900 leading-tight">
              The Great Controversy: <br/>
              <span className="text-gray-500 font-light italic">Lesson 03: The Light Shines in the Darkness</span>
            </h1>
            <p className="text-lg text-gray-600 leading-relaxed max-w-2xl">
              This week, we explore the steadfast faith of the Waldenses and the early Reformers who kept the flame of truth alive during the Middle Ages.
            </p>
        ...
        <div className="lg:col-span-2 space-y-10">
          <section className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100">
            <h2 className="text-2xl font-bold text-gray-800 mb-8 flex items-center gap-3">
              <FontAwesomeIcon icon={faCalendarCheck} className="text-[#3298C8]" />
              Sabbath Morning Program
            </h2>
            <div className="space-y-0">
              {weeklySchedule.map((item, i) => (
                <div key={i} className="flex items-center justify-between py-5 border-b border-gray-50 last:border-0 hover:bg-sky-50 transition-colors px-4 rounded-xl">
                  <div>
                    <span className="text-[#3298C8] font-bold text-sm block">{item.time}</span>
                    <h4 className="font-bold text-gray-800">{item.activity}</h4>
                  </div>
                  <div className="text-right">
                    <span className="text-xs text-gray-400 uppercase font-bold tracking-widest">Lead By</span>
                    <p className="text-sm text-gray-600">{item.lead}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <section className="grid md:grid-cols-2 gap-6">
            <div className="bg-sky-900 text-white p-8 rounded-3xl space-y-4">
              <FontAwesomeIcon icon={faUsers} className="text-sky-300 text-3xl" />
              <h3 className="text-xl font-bold">Adult Classes</h3>
              <p className="text-sky-100/70 text-sm">Join our diverse discussion groups catering to different languages and age groups in the main sanctuary.</p>
            </div>
            <div className="bg-amber-500 text-white p-8 rounded-3xl space-y-4">
              <FontAwesomeIcon icon={faLightbulb} className="text-amber-200 text-3xl" />
              <h3 className="text-xl font-bold">Teacher Resources</h3>
              <p className="text-amber-100/70 text-sm">Access teaching outlines, powerpoint presentations, and video summaries for the current week.</p>
            </div>
          </section>
        </div>
        ...
        <div className="space-y-8">
          <div className="bg-white rounded-3xl overflow-hidden shadow-sm border border-gray-100">
            ...
            <div className="p-6">
              <p className="text-sm text-gray-500 italic text-center">
                Watch a 5-minute summary of this week&apos;s key spiritual insights.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
            ...
            <div className="p-4 bg-sky-50 rounded-2xl border-l-4 border-[#3298C8]">
              ...
              <p className="text-right text-[#3298C8] font-bold text-xs mt-2">— Psalm 119:105</p>
            </div>
          </div>
        </div>
