            ...
            <div className="grid sm:grid-cols-2 gap-8">
              <div className="space-y-2">
                ...
                <p className="text-sm text-gray-600">
                  Cross-reference scripture verses and find word origins in
                  Hebrew and Greek.
                </p>
              </div>
              <div className="space-y-2">
                ...
                <p className="text-sm text-gray-600">
                  Download visual timelines of Daniel 2, 7, and 8 for your
                  personal study.
                </p>
              </div>
            </div>
        ...
        <div className="space-y-8">
          <div className="bg-[#3298C8] p-8 rounded-[2.5rem] text-white shadow-lg relative overflow-hidden">
            ...
            <p className="text-sky-100 italic leading-relaxed">
              &quot;The Bible is its own expositor. One passage will prove to be
              a key that will unlock other passages, and in this way light will
              be shed upon the hidden meaning of the word.&quot;
            </p>
          ...
          <div className="bg-gray-900 p-8 rounded-[2.5rem] text-white space-y-6">
            ...
            <p className="text-sm text-gray-400 leading-relaxed">
              Bible study is more impactful when discussed with others. We have
              small groups meeting in various neighborhoods.
            </p>
