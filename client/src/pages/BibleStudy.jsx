  ...
  return (
    <div className="bg-[#F6EBEB] min-h-screen">
      ...
      <section className="relative h-125 flex items-center overflow-hidden">
        <img src={currentSeries.img} className="absolute inset-0 w-full h-full object-cover" alt="Bible Background" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-white space-y-6">
          ...
          <div className="flex items-center gap-4 text-gray-300">
            <FontAwesomeIcon icon={faMicrophone} className="text-amber-400" />
            <span className="font-medium text-lg">Led by {currentSeries.speaker}</span>
          </div>
      ...
      <div className="max-w-7xl mx-auto py-20 px-6 grid grid-cols-1 lg:grid-cols-3 gap-16">
        ...
        <div className="lg:col-span-2 space-y-12">
          <section className="space-y-6">
            <h2 className="text-3xl font-bold text-gray-800 flex items-center gap-3">
              <FontAwesomeIcon icon={faCompass} className="text-[#3298C8]" />
              Study Schedule
            </h2>
            <div className="space-y-4">
              {upcomingTopics.map((topic, i) => (
                <div key={i} className="bg-white p-6 rounded-3xl shadow-sm border border-gray-100 flex items-center justify-between group hover:border-[#3298C8] transition-all">
                  <div className="flex items-center gap-6">
                    ...
                    <div>
                      <h4 className="font-bold text-xl text-gray-800">{topic.title}</h4>
                      <p className="text-sm text-gray-500 italic">Mid-week Bible Seminar</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <p className="font-bold text-gray-700">{topic.date}</p>
                    <p className="text-xs text-[#3298C8] flex items-center justify-end gap-1 font-bold">
                      <FontAwesomeIcon icon={faClock} className="text-[10px]" /> {topic.time}
                    </p>
                  </div>
                </div>
              ))}
          ...
          <section className="bg-white p-10 rounded-[3rem] shadow-xl border border-gray-50">
            <div className="flex items-center gap-4 mb-8">
              <FontAwesomeIcon icon={faBookOpenReader} className="text-4xl text-amber-500" />
              <div>
                <h3 className="text-2xl font-bold text-gray-800">Study Resources</h3>
                <p className="text-gray-400">Deepen your understanding with these tools</p>
              </div>
            </div>
            <div className="grid sm:grid-cols-2 gap-8">
              <div className="space-y-2">
                <h4 className="font-bold text-[#3298C8]">Concordance Search</h4>
                <p className="text-sm text-gray-600">Cross-reference scripture verses and find word origins in Hebrew and Greek.</p>
              </div>
              <div className="space-y-2">
                <h4 className="font-bold text-[#3298C8]">Prophecy Charts</h4>
                <p className="text-sm text-gray-600">Download visual timelines of Daniel 2, 7, and 8 for your personal study.</p>
              </div>
            </div>
          </section>
        </div>
        ...
        <div className="space-y-8">
          <div className="bg-[#3298C8] p-8 rounded-[2.5rem] text-white shadow-lg relative overflow-hidden">
            <FontAwesomeIcon icon={faBible} className="absolute -bottom-6 -right-6 text-9xl opacity-10" />
            ...
            <p className="text-right mt-4 text-xs font-bold uppercase tracking-widest">— E.G. White</p>
          </div>

          <div className="bg-gray-900 p-8 rounded-[2.5rem] text-white space-y-6">
            <h3 className="text-xl font-bold border-b border-white/10 pb-4 text-amber-400">Join a Small Group</h3>
            <p className="text-sm text-gray-400 leading-relaxed">
              Bible study is more impactful when discussed with others. We have small groups meeting in various neighborhoods.
            </p>
            <button className="w-full bg-amber-500 text-black py-3 rounded-xl font-bold hover:bg-amber-400 transition-colors">
