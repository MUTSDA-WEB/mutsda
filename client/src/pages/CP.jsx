...
const CPPage = () => {
  const archives = [
    ...
    },
    {
      ...
      period: "2010 - 2025",
      type: "Digital & Hard Copy",
    },
    {
      title: "Historical Photos",
      period: "Founding - Present",
      type: "Physical Album",
    },
    {
      title: "Guest Speaker Register",
      period: "2015 - Present",
      type: "Ledger",
    },
  ];
  ...
  return (
    <div className="bg-[#F6EBEB] min-h-screen">
      ...
      <section className="bg-[#3298C8] py-20 text-white text-center px-6 relative">
        <FontAwesomeIcon
          icon={faBullhorn}
          className="absolute top-1/2 left-10 text-9xl opacity-10 -translate-y-1/2 -rotate-12 hidden lg:block"
        />
        <div className="relative z-10">
          ...
          <p className="text-xl max-w-3xl mx-auto font-light opacity-90">
            Broadcasting the Gospel and preserving the heritage of MUTSDA
            through modern media and physical archives.
          </p>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto py-16 px-6 space-y-20">
        ...
        <section className="grid md:grid-cols-3 gap-8">
          <div className="bg-white p-8 rounded-3xl shadow-sm border-b-4 border-sky-400">
            <FontAwesomeIcon
              icon={faMicrophone}
              className="text-[#3298C8] text-3xl mb-4"
            />
            <h3 className="text-xl font-bold mb-2">Media & PR</h3>
            <p className="text-gray-600 text-sm">
              Managing the church&apos;s public image, social media, and
              technical coverage of all services.
            </p>
          </div>
          <div className="bg-white p-8 rounded-3xl shadow-sm border-b-4 border-amber-400">
            <FontAwesomeIcon
              icon={faBookOpen}
              className="text-amber-500 text-3xl mb-4"
            />
            <h3 className="text-xl font-bold mb-2">Publishing</h3>
            <p className="text-gray-600 text-sm">
              Producing weekly bulletins, newsletters, and missionary tracts for
              the congregation.
            </p>
          </div>
          <div className="bg-white p-8 rounded-3xl shadow-sm border-b-4 border-green-400">
            ...
            <p className="text-gray-600 text-sm">
              Safe-guarding the physical books, records, and historical
        ...
        <section className="bg-white rounded-[3rem] overflow-hidden shadow-xl flex flex-col lg:flex-row border border-gray-100">
          <div className="w-full lg:w-1/2 bg-gray-900 p-12 text-white flex flex-col justify-center space-y-6">
            ...
            <p className="text-gray-400 leading-relaxed">
              Our department manages the church&apos;s physical repository.
              While our digital library offers many resources, the C&P
              department maintains original Spirit of Prophecy books, rare SDA
              publications, and the church’s historical records that are only
            ...
            <div className="bg-white/10 p-4 rounded-xl flex gap-4 items-center">
              ...
              <p className="text-xs italic">
                Members must visit the C&P Office to request or check out
                physical books.
              </p>
            </div>
          </div>
          ...
          <div className="w-full lg:w-1/2 p-12">
            <h3 className="text-2xl font-bold mb-6 text-gray-800 underline decoration-sky-300">
              Archive Categories
            </h3>
            <div className="space-y-4">
              {archives.map((item, idx) => (
                <div
                  key={idx}
                  className="flex items-center justify-between p-4 bg-gray-50 rounded-2xl hover:bg-sky-50 transition-colors"
                >
                  <div>
        ...
        <section className="text-center space-y-12">
          <div className="space-y-2">
            ...
            <p className="text-gray-500">
              How we keep the congregation informed
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div
                key={i}
                className="flex flex-col items-center p-8 bg-white rounded-3xl shadow-sm border border-transparent hover:border-[#3298C8] transition-all"
              >
                <div
                  className={`w-16 h-16 rounded-2xl mb-4 flex items-center justify-center ${channel.color}`}
                >
