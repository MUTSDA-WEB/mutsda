      ...
      <div className="max-w-7xl mx-auto py-20 px-6 grid grid-cols-1 lg:grid-cols-12 gap-16">
        ...
        <div className="lg:col-span-5 space-y-12">
          <div className="space-y-4">
            <h1 className="text-5xl font-black text-gray-900 tracking-tighter uppercase">Reach Out</h1>
            <p className="text-lg text-gray-600 leading-relaxed">
              Whether you are looking for a spiritual home, need prayer, or want to learn more about our ministries, we are here for you.
            </p>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-start gap-6 group">
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm">Wed & Fri: 6:00pm - 8:00pm</p>
              </div>
            </div>
          </div>
            ...
            <form className="relative z-10 space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label className="text-xs font-bold uppercase text-gray-400 ml-2">Your Name</label>
                  <input type="text" className="w-full p-4 rounded-2xl bg-gray-50 border-none focus:ring-2 focus:ring-[#3298C8] transition-all outline-none" placeholder="John Doe" />
                </div>
                <div className="space-y-2">
                  <label className="text-xs font-bold uppercase text-gray-400 ml-2">Email Address</label>
                  <input type="email" className="w-full p-4 rounded-2xl bg-gray-50 border-none focus:ring-2 focus:ring-[#3298C8] transition-all outline-none" placeholder="john@example.com" />
                </div>
              </div>
              
              <div className="space-y-2">
                <label className="text-xs font-bold uppercase text-gray-400 ml-2">Subject</label>
              ...
              <div className="space-y-2">
                <label className="text-xs font-bold uppercase text-gray-400 ml-2">Message</label>
                <textarea className="w-full p-4 rounded-2xl bg-gray-50 border-none focus:ring-2 focus:ring-[#3298C8] transition-all outline-none h-40 resize-none" placeholder="How can we help?"></textarea>
              </div>

              <button type="submit" className="w-full bg-[#3298C8] text-white py-4 rounded-2xl font-black uppercase tracking-widest hover:bg-sky-700 shadow-lg shadow-sky-200 transition-all active:scale-[0.98]">
                Send Message
              </button>
            </form>
          </div>
