    ...
    <div className="flex flex-col animate-fadeIn">
      ...
      <section className="relative h-[75vh] flex items-center justify-center text-white overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4">
          <h1 className="text-4xl md:text-6xl font-bold mb-4 tracking-tight">Welcome to MUTSDA</h1>
      ...
      <div className="max-w-6xl mx-auto w-full py-16 px-6 space-y-20">
        ...
        <div className="inline-block relative">
            <h2 className="text-4xl font-black text-gray-800 tracking-tight uppercase">Upcoming Events</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div key={event.id} className="group relative bg-white rounded-4xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500">
                {/* Image Container */}
                ...
                <div className="absolute top-4 left-4 bg-white rounded-2xl p-2 px-4 shadow-md text-center">
                    <span className="block text-[#3298C8] font-black text-lg leading-none">{event.date.split(' ')[1]}</span>
                    <span className="block text-gray-400 text-[10px] font-bold uppercase">{event.date.split(' ')[0]}</span>
                </div>
                </div>
                ...
                <div className="pt-4 flex items-center justify-between">
                    ...
                    {[1, 2, 3].map(i => (
                        <img key={i} className="w-6 h-6 rounded-full border-2 border-white" src={`https://i.pravatar.cc/100?u=${event.id + i}`} alt="Attendee" />
                    ))}
                    <div className="w-6 h-6 rounded-full border-2 border-white bg-gray-100 flex items-center justify-center text-[8px] font-bold text-gray-400">+12</div>
                    </div>
                </div>
                </div>
            </div>
        ...
        <div className="text-center">
            <h2 className="text-4xl font-black text-gray-800 tracking-tight">Divine Worship & Fellowships</h2>
            <p className="text-sky-600 font-medium mt-2">Join us as we seek the Lord together</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 px-2">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8 space-y-4">
                ...
                <h3 className="text-3xl font-bold text-white">Sabbath Service</h3>
                ...
                A full day of spiritual nourishment starting with Sabbath School, followed by Divine Worship and afternoon Bible study.
                </p>
            ...
            <div className="relative group h-112.5 rounded-3xl overflow-hidden shadow-2xl transition-all duration-500 hover:scale-[1.01]">
            <img 
                src="https://images.unsplash.com/photo-1438232992991-995b7058bbb3?q=80&w=1200"                alt="Prayer Meeting" 
                className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
            />
            <div className="absolute inset-0 bg-linear-to-t from-black/90 via-black/40 to-transparent"></div>
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8 space-y-4">
                ...
                <h3 className="text-3xl font-bold text-white">Weekly Vespers</h3>
                <p className="text-gray-300 max-w-md transform translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500">
                Recharge your spirit during our mid-week prayer sessions and welcome the Sabbath with our Friday evening vespers.
                </p>
                <div className="flex items-center gap-4 text-white/80 text-sm">
                <FontAwesomeIcon icon={faClock} className="text-[#3298C8]" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch">
            ...
            <div className="bg-[#3298C8] p-8 text-white">
                ...
                <p className="text-sky-100 text-sm">Have a question or need prayer? Our team is here to listen and support you.</p>
            </div>
            
            <div className="p-8 space-y-4 grow">
                <div className="space-y-1">
                <label className="text-xs font-bold text-gray-400 uppercase ml-1">Full Name</label>
                <input type="text" placeholder="e.g. John Doe" className="w-full p-4 rounded-2xl bg-gray-50 border-none focus:ring-2 focus:ring-sky-400 outline-none transition-all placeholder:text-gray-300" />
                </div>
                <div className="space-y-1">
                <label className="text-xs font-bold text-gray-400 uppercase ml-1">Your Message</label>
                <textarea placeholder="How can we help you today?" className="w-full p-4 rounded-2xl bg-gray-50 border-none h-32 focus:ring-2 focus:ring-sky-400 outline-none transition-all resize-none placeholder:text-gray-300"></textarea>
                </div>
            ...
            <div className="bg-linear-to-br from-amber-500 to-orange-600 p-8 text-white">
                ...
                <p className="text-amber-100 text-sm">Join our missionary team and make an impact in the community.</p>
            </div>
            
            <div className="p-8 space-y-4 grow">
                <div className="space-y-1 text-gray-400">
                <label className="text-xs font-bold uppercase ml-1">Volunteer Name</label>
                <input type="text" placeholder="Enter your name" className="w-full p-4 rounded-2xl bg-white/5 border border-white/10 text-white focus:ring-2 focus:ring-amber-500 outline-none transition-all placeholder:text-gray-600" />
                </div>
                <div className="space-y-1 text-gray-400">
                <label className="text-xs font-bold uppercase ml-1">Phone Number</label>
                <input type="text" placeholder="+254..." className="w-full p-4 rounded-2xl bg-white/5 border border-white/10 text-white focus:ring-2 focus:ring-amber-500 outline-none transition-all placeholder:text-gray-600" />
                </div>
                <div className="pt-2">
                <p className="text-[10px] text-gray-500 mb-4 italic px-1 text-center font-light">By clicking the button below, you agree to be contacted by the mission coordinator.</p>
