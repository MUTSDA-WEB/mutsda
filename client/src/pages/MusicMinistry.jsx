...
const MusicMinistry = () => {
   ...
   const subChoirs = siteData?.choirs || [];
            ...
            <section className='flex flex-col lg:flex-row items-center gap-12'>
               ...
               <div className='w-full lg:w-1/2 space-y-6'>
                  ...
                  <p className='text-lg text-gray-600 leading-relaxed'>
                     The heart of our musical worship, the Main Church Choir
                     leads the congregation every Sabbath. Comprising dedicated
                     men and women, the choir specializes in majestic anthems
                  ...
                  {!showMainChoirForm ? (
                     <button
                        onClick={() => setShowMainChoirForm(true)}
                        className='bg-[#3298C8] text-white px-8 py-3 rounded-full font-bold shadow-lg hover:bg-sky-700 transition-all'
                     >
                        Join the Choir
                     </button>
                  ) : (
                     <div className='bg-gray-50 p-6 rounded-3xl border border-gray-100'>
                        <JoinForm
                           isOpen={showMainChoirForm}
                           onClose={() => setShowMainChoirForm(false)}
                           title='Join the Main Choir'
               ...
               <div className='grid md:grid-cols-3 gap-8'>
                  {subChoirs.length === 0 ? (
                     <div className='col-span-3'>
                        <NoData info='No choirs or singing groups available yet.' />
                     </div>
                  ) : (
                        ...
                        >
                           {activeGroupForm !== index ? (
                              ...
                              <JoinForm
                                 ...
                                 onClose={() => setActiveGroupForm(null)}
                                 title={`Join ${choir.name}`}
