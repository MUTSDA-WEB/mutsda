    ...
    <header className="bg-[#3298C8] text-white sticky top-0 z-50 shadow-md">
      <div className="flex items-center justify-between px-6 py-4 max-w-7xl mx-auto">
        ...
        <nav className="hidden lg:flex gap-8 text-sm font-medium uppercase tracking-wider items-center">
          ...
          <Link to="/aboutUs" className="hover:text-sky-200 transition-colors">
            About Us
          </Link>
          ...
          <Link to="/library" className="hover:text-sky-200 transition-colors">
            Library
          </Link>
          <Link to="/leaders" className="hover:text-sky-200 transition-colors">
            Leadership
          </Link>
        </nav>
